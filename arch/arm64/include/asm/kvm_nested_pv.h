...
#define write_sysreg_pv(v, sreg) do {                    \
        u64 __val = (u64)v;                             \
...
#define kvm_read_sysreg(r) 	read_sysreg_pv(r)
#define kvm_write_sysreg(v, r)	write_sysreg_pv(v, r)
#define kvm_read_sysreg_el1(r) 	read_sysreg_pv(r##_el1)
